...
class PacketManager
{
    ...
    {
       _onRecvMap.Add((ushort)EPacketID.PlayerInfoReq, MakePacket<PlayerInfoReq>);
        _handlerMap.Add((ushort)EPacketID.PlayerInfoReq, PacketHandler.PlayerInfoReqHandler);

       _onRecvMap.Add((ushort)EPacketID.Test, MakePacket<Test>);
        _handlerMap.Add((ushort)EPacketID.Test, PacketHandler.TestHandler);
